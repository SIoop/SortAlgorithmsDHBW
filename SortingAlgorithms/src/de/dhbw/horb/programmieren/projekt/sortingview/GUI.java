...
import de.dhbw.horb.programmieren.projekt.sortcontroller.UserInput;
...
public class GUI extends GridPane {
	...
	public GUI() {
		...
		btnCancel.setOnAction(controller);
	...
	public UserInput getUserInputOptions () throws IncorrectInputException {
		
		UserInput options = new UserInput();
